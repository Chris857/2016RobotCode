...
public class Robot extends SampleRobot {
		...
		//Constants
		NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(50, 120);	//Default hue range for yellow tote
		...
		public void robotInit() {
			...
			lidar = new LidarSubsystem(edu.wpi.first.wpilibj.I2C.Port.kMXP);
		...
		public void operatorControl() {
	        ...
	        while (isOperatorControl() && isEnabled()) {
				...
				if(numParticles > 0)
				{
					...
					SmartDashboard.putBoolean("IsTarget", isTote);
