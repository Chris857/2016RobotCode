...
public class getGamePadButton {
	...
	//TODO: Need to calibrate these angles and functions!
	
	public boolean getUp() {
		return (joystick.getPOV() == 0 || joystick.getPOV() == 45 || joystick.getPOV() == 315);
	}
	
	public boolean getDown() {
		return (joystick.getPOV() <= 225 && joystick.getPOV() >= 135);
	}
	
	public boolean getLeft() {
		return (joystick.getPOV() <= 315 && joystick.getPOV() >= 225);
	}
	
	public boolean getRight() {
		return (joystick.getPOV() <= 135 && joystick.getPOV() >= 45);
	}
